...
public class RegularVendingMachine extends VendingMachine {
    ...
    public void testFeatures(JTextArea outputTextArea) {
        ...
        for (String itemName : inventory.keySet()) {
            ...
            outputTextArea.append(itemIndex + ". " + itemName + " - Price: " + slot.item.getPrice() + " - Quantity: "
                    + slot.getQuantity() + "\n");
            itemIndex++;
        }
        ...
        double amountToInsert = Double
                .parseDouble(javax.swing.JOptionPane.showInputDialog("Enter the amount to insert (e.g., 20.0): "));
